Every component in React should strictly follow Single Responsibilty which will help in writing test cases efficiently and can catch the errors easily when building a scalable application.
