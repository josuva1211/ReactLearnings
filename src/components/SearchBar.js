...
const SearchBar = ({onSearch}) => {
    ...
    return (
        <div>
            ...
            <input type="text" value={loggedInUser} onChange={(e) => setUserName(e.target.value)} className="shadow appearance-none border rounded border-8 border-solid border-orange-500 my-4 mr-4 py-2 px-3 text-orange-500 leading-tight focus:outline-none focus:shadow-outline" />
